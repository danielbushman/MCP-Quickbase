...
export class CreateAppTool extends BaseTool<CreateAppParams, CreateAppResult> {
  ...
  public description =
    "Creates a new Quickbase application. Only use this tool when explicitly asked to create a new application.";
  ...
  protected async run(params: CreateAppParams): Promise<CreateAppResult> {
    ...
    if (!response.success || !response.data) {
      ...
      throw new Error(
        response.error?.message || "Failed to create application",
      );
    }
